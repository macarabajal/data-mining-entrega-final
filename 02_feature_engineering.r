...
# DESCRIPCION
# ------------------------------------------------------------------------------
# Genera un nuevo dataset de entrenamiento realizando las siguientes acciones como parte del feature engineering:
# 1- Corrige los con ratios del 100% de valores NA y 0 (Corregir_MachineLearning)
# 2- Agregar variables a partir de las originales (AgregarVariables)
# 3- Agregar variables lags y delta lags de orden 1, 2 y/o 3
# 4- Agregar campos de tendencia, minimo, maximo, promedio, ratio de promedio y máximo con un lag de 6 meses (TendenciaYmuchomas)
# 5- Agregar campos con valores {0,1} que provienen de las hojas de un Random Forest
# 6- Aplicar la tecnica de canaritos asesinos para disminuir la cantidad de variables y quedarse con las de mayor importancia
...
kdataset       <- "./datasets/historia_2022_ajustadoIPC_MESES.csv.gz"
...
#--------------------------------------
# LAGS y DELTA LAGS de orden 2 (Comentar si no se desea incluir)
#--------------------------------------
...
#--------------------------------------
# LAGS y DELTA LAGS de orden 3 (Comentar si no se desea incluir)
#--------------------------------------
...
#grabo el dataset
fwrite( dataset,
        "./datasets/dataset_FE_historico_LAG3.csv.gz",
        logical01= TRUE,
        sep= "," )
